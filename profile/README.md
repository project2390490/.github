...
<img width="1280" height="720" alt="image" src="https://github.com/user-attachments/assets/3a6f66c2-adec-4f9c-839c-dc99ee2ab2b4" />
...
<img width="1280" height="720" alt="image" src="https://github.com/user-attachments/assets/22718a0c-bfcf-4f25-8f9f-5ef4b3ba9d8c" />
...
```mermaid
flowchart TD
A[Launch Titan Quest II] --> B[Run Trainer]
B --> C[Activate Overlay]
C --> D{Select Feature}
D -->|Gold| E[Unlimited Resources]
D -->|XP| F[Instant Level Ups]
D -->|Gear| G[Spawn Legendary Items]
D -->|Survival| H[Enable God Mode]
D -->|Power| I[Boost Damage & Cooldowns]
```
